...
function ProductList({ onHomeClick }) {
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        // TODO: Implement plants page navigation
  ...
  <div className="product-page">
    ...
    <header className="navbar">
      <div className="navbar-left">
        <a href="/" onClick={(e) => handleHomeClick(e)} className="navbar-logo">
          <img
      ...
      <nav className="navbar-right">
        ...
        <button className="cart-btn" onClick={(e) => handleCartClick(e)}>
      ...
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map((category, index) => (
            <section key={index} className="product-category">
